...
<body>
    <div class="head">
            <h3 class="head_text fr">植物标本后台管理系统</h3>
    </div>
    ...
    <div class="content clearfix">
        ...
        <div class="menu">
            <div class="cont">
                ...
                <ul class="mList">
                    <li>
                        <h3><span onclick="show('menu1','change1')" id="change1">+</span>图片管理</h3>
                        <dl id="menu1" style="display:none;">
                        	<dd><a href="addPro.php" target="mainFrame">添加标本</a></dd>
                            <dd><a href="listPro.php" target="mainFrame">标本列表</a></dd>
                        </dl>
                    </li>
                    <li>
                        ...
                        <dl id="menu2" style="display:none;">
                            ...
                            <dd><a href="listCate.php" target="mainFrame">界列表</a></dd>
                            <dd><a href="listphylum.php" target="mainFrame">门列表</a></dd>
                            <dd><a href="listgang.php" target="mainFrame">纲列表</a></dd>
                            <dd><a href="listmu.php" target="mainFrame">目列表</a></dd>
                            <dd><a href="listke.php" target="mainFrame">科列表</a></dd>
                            <dd><a href="listgenus.php" target="mainFrame">属列表</a></dd>
                        </dl>
                    </li>
                    ...
                    <li>
                        ...
                        <dl id="menu4" style="display:none;">
                            ...
                            <dd><a href="listproblem.php"target="mainFrame">用户贴子</a></dd>
                        </dl>
                    </li>
                    <li>
